...
var style_india_ds_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("Book1_Population");
    var labelText = "";
    size = 0;
    ...
    if (value >= 101722.000000 && value <= 187738.600000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 187738.600000 && value <= 269348.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 269348.000000 && value <= 346766.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 346766.400000 && value <= 429615.400000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 429615.400000 && value <= 499578.000000) {
            style = [ new ol.style.Style({
